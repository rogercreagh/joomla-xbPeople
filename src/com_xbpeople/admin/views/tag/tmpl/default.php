...
<?php endif;?>
		...
		<div class="row-fluid xbmb8">
			<div class= "span3">
				  <h3><?php echo JText::_('COM_XBFILMS_TAG_ITEMS'); ?></h3>
			</div>
			<div class="span5">
            ...
            <div class="span2">
                <p><?php echo '<i>'.JText::_('COM_XBFILMS_CAPALIAS').'</i>: '.$item->alias; ?></p>
            </div>
			<div class= "span2">
		...
		<div class="row-fluid xbmb8">
			<div class= "span6">
					<p class="xb11"><i><?php echo JText::_('COM_XBFILMS_CAPTAG').' '.Jtext::_('COM_XBFILMS_CAPHEIRARCHY'); ?>: </i>
					<?php $path = str_replace('/', ' - ', $item->path);
						echo 'root - '.$path; ?>
					</p>
			</div>
			<div class= "span6">
				<p><i><?php echo Jtext::_('COM_XBFILMS_ADMIN_NOTE'); ?>:</i>  <?php echo $item->note; ?></p>
			</div>
		</div>
		<div class="row-fluid xbmb8">
			<div class= "span2">
				<p><i><?php echo JText::_('COM_XBFILMS_CAPDESCRIPTION'); ?>:</i></p>
			</div>
   			<div class="span10">
    		...
    		<?php else: ?>
    			<p><i><?php echo JText::_('COM_XBFILMS_NO_DESCRIPTION'); ?></i></p>
			<?php endif; ?>
			</div>
		</div>
		<div class="row-fluid">
