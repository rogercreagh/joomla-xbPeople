...
//             }
    ...
    public function check() {
    	...
    	if (($this->id == 0) && (XbpeopleHelper::checkTitleExists($name,'#__xbgroups'))) {
    	    $this->setError(Text::_('Group "'.$title.'" already exists; if this is a different individual with the same name please append something to the name to distinguish them'));
    	    return false;
    	}
